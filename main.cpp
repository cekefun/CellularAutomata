...
void runSimulation(std::size_t elementSize, std::int64_t min, std::int64_t max, std::uint8_t rule) {
...
int main() {
    ...
    runSimulation(1, -32, 32, 30);
    runSimulation(1, -32, 32, 126);
    runSimulation(1, -32, 32, 255);
